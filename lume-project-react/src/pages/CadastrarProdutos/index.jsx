...
function CadastrarProdutos() {
    ...
    const [formData, setFormData] = useState({
        productName: '',
        companyName: '',
        categoria: '', // será a subcategoria
        description: '',
        imageUrl: null, // Imagem principal em Base64
        galleryImages: [], // outas imagens em Base64
        imageAlt: '',
        originalPrice: '',
        currentPrice: '',
        discountPercentage: '',
    ...
    const handleImageChange = (e, isGallery = false) => {
        ...
        Promise.all(filePromises).then(base64Images => {
            if (isGallery) {
                setFormData(prev => ({ ...prev, galleryImages: [...prev.galleryImages, ...base64Images] }));
            } else {
                setFormData(prev => ({ ...prev, imageUrl: base64Images[0] }));
            }
        });
    };
    ...
    const handleSubmit = (e) => {
        ...
        setFormData({
            productName: '', companyName: '', categoria: '', description: '', imageUrl: null,
            galleryImages: [], imageAlt: '', originalPrice: '', currentPrice: '',
            discountPercentage: '', installments: '', shippingInfo: '', benefits: '',
            specialDiscount: '', isVerified: false, features: '', reviews: [],
            ratingSummary: {}, relatedProducts: []
        });
            ...
            <div className={styles.formContainer}>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    <div className={styles.formGrid}>
                        ...
                        <div className={styles.formGroup}><label htmlFor="imageAlt">Texto Alternativo da Imagem*</label><input type="text" id="imageAlt" name="imageAlt" value={formData.imageAlt} onChange={handleChange} placeholder="Descreva a imagem (acessibilidade)" required /></div>
                        ...
                        <div className={styles.formGroup}><label htmlFor="originalPrice">Preço Original (R$)</label><input type="number" step="0.01" id="originalPrice" name="originalPrice" value={formData.originalPrice} onChange={handleChange} placeholder="Ex: 99.90 (sem desconto)" /></div>
                    ...
                    <div className={styles.imageUploadGrid}>
                        ...
                        <div className={styles.imageUploadSection}>
                            <h3>Galeria de Imagens (Opcional)</h3>
